...
class captcha {
    ...
    public function form ($para = array()) {
    	...
    	if(!isset($para['len'])) $para['len'] = '4';
    	if(!isset($para['color'])) $para['color'] = 'rand';
    	if(!isset($para['style'])) $para['style'] = 'both';
    	if(!isset($para['the_text'])) $para['the_text'] = '';
    	if(!isset($para['width'])) $para['width'] = '75';
    	if(!isset($para['height'])) $para['height'] = '25';
    	if(!isset($para['cx'])) $para['cx'] = '15';
    	if(!isset($para['cy'])) $para['cy'] = '5';
    	if(!isset($para['s_path'])) $para['s_path'] = '';
    	if(!isset($para['sim_nam'])) $para['sim_nam'] = time();
    	if(!isset($para['font'])) $para['font'] = '';
    	if(!isset($para['im_path'])) $para['im_path'] = '';
